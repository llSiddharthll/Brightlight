...
let StudentVisaMeta = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/studentVisaMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/studentVisaMeta")
      .then((res) => res.json())
      .then((data) => {
...
export default StudentVisaMeta;
