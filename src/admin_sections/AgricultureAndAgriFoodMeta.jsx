...
let AgricultureAndAgriFoodMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/agricultAndAgriFoodOccuMeta/${metaData._id}`, {
      method: "PUT",
      headers: {
...
export default AgricultureAndAgriFoodMeta;
