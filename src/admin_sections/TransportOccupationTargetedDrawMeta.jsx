...
let TransportOccupationTarMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/transportOccuptionTargDrawMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
...
export default TransportOccupationTarMeta;
