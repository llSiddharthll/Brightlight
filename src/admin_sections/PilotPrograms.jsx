...
const PilotProgramContent = () => {
  ...
  const handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/pilotProgram/${sectionDataSingle._id}`,
      {
        method: "PUT",
        headers: {
  ...
  return (
    <div className={styles.singleSectionData}>
      ...
      <input
        placeholder="Pilot Program Heading"
        name="pilotProgramHeading"
        value={sectionDataSingle.pilotProgramHeading || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
      <textarea
        placeholder="Pilot Program Paragraph 1"
        name="pilotProgramPara1"
        value={sectionDataSingle.pilotProgramPara1 || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
      <textarea
        placeholder="Pilot Program Paragraph 2"
        name="pilotProgramPara2"
        value={sectionDataSingle.pilotProgramPara2 || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />

      <input
        placeholder="Here Heading"
        name="HereHeading"
        value={sectionDataSingle.HereHeading || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
...
export default PilotProgramContent;
