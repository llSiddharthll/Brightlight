...
const PrRenewalContent = () => {
  ...
  const handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/pr-renewal/${sectionDataSingle._id}`,
      {
        method: "PUT",
        headers: {
  ...
  return (
    <div className={styles.singleSectionData}>
      ...
      <input
        placeholder="PR Renewal Heading"
        name="PrRenewalHeading"
        value={sectionDataSingle.PrRenewalHeading || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
      <textarea
        placeholder="PR Renewal Paragraph 1"
        name="PrRenewalPara1"
        value={sectionDataSingle.PrRenewalPara1 || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
      <textarea
        placeholder="PR Renewal Paragraph 2"
        name="PrRenewalPara2"
        value={sectionDataSingle.PrRenewalPara2 || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
      <input
        ...
        value={sectionDataSingle.EligibleHeading || ""}
        onChange={handleInputChange}
        disabled={!editMode}
      />
      <textarea
...
export default PrRenewalContent;
