...
let VisitorVisaMeta = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/visitorVisaMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
  ...
  useEffect(() => {
    fetch("https://brightlight-node.onrender.com/visitorVisaMeta")
      .then((res) => res.json())
      .then((data) => {
...
export default VisitorVisaMeta;
