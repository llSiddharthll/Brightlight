...
let FederalSkilledWorkerProgramMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/federalSkillWorkerProgMeta/${metaData._id}`, {
      method: "PUT",
      headers: {
...
export default FederalSkilledWorkerProgramMeta;
