...
let OpenWorkForSpousalInlandMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/OpenWorkPermitForSpouseInMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
...
export default OpenWorkForSpousalInlandMeta;
