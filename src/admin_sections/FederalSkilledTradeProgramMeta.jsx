...
let FederalSkilledTradeProgramMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/federalSkillTradesProgMeta/${metaData._id}`, {
      method: "PUT",
      headers: {
...
export default FederalSkilledTradeProgramMeta;
