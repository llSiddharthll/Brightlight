...
let LMIAReviewedMeta = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/LmiaMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
  ...
  useEffect(() => {
    fetch(
      "https://brightlight-node.onrender.com/LmiaMeta"
    )
      .then((res) => res.json())
      .then((data) => {
...
export default LMIAReviewedMeta;
