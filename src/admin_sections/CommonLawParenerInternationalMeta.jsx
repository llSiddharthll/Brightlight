...
let CommonLawPartnerInternationalMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/comLawPartnerInternMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
...
export default CommonLawPartnerInternationalMeta;
