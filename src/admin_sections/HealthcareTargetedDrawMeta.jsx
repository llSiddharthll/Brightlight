...
let HeathcareTargetedDrawMeta = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/healthcareTargatedDrawMeta/${metaData._id}`, {
      method: "PUT",
      headers: {
...
export default HeathcareTargetedDrawMeta;
