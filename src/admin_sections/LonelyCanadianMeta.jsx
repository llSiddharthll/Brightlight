...
let LonelyCanadianMeta = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/lonelyCanadianMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
  ...
  useEffect(() => {
    fetch(
      "https://brightlight-node.onrender.com/lonelyCanadianMeta"
    )
      .then((res) => res.json())
      .then((data) => {
...
export default LonelyCanadianMeta;
