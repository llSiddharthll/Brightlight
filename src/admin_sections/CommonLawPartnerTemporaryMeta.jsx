...
let CommonLawPartnerTemporaryContentMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(
      `https://brightlight-node.onrender.com/comLawPartTempMeta/${metaData._id}`,
      {
        method: "PUT",
        headers: {
...
export default CommonLawPartnerTemporaryContentMeta;
