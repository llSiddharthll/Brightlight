...
let HealthAuthoritiesStreamMeta = () => {
  let notifySuccess = () => {
  ...
  let handleUpdateClick = () => {
    ...
    fetch(`https://brightlight-node.onrender.com/healthAuthorityStreamMeta/${metaData._id}`, {
      method: "PUT",
      headers: {
...
export default HealthAuthoritiesStreamMeta;
